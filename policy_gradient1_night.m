function [tot_energy,compute_energy,communication_energy,compute_delay,communication_delay,accuracy_ret] = policy_gradient1_night(delay_constraint,accuracy_constraint)
...
[Observation,Reward,IsDone,LoggedSignals,tot_energy,compute_energy,communication_energy,compute_delay,communication_delay,accuracy_ret] = myStepFunction_night(Action,LoggedSignal);

env = rlFunctionEnv(ObservationInfo,ActionInfo,'myStepFunction_night','myResetFunction_night');
