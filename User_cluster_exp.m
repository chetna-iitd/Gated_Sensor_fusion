function [info_clust info_clust1 num_users X_v idx idx_vr pos application config_num_overall] = User_cluster_exp(num_users,num_clusters,num_applications,snr_user)
...
pos(:,4)=snr_user;%accurate_SINR_user(pos, pos(:,3), num_users*size(X_v,2)); %%% obtain SINR
