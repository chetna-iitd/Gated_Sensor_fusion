function [compute_energy1, compute_energy2, communication_energy1, communication_energy2, tot_energy1, tot_energy2,compute_delay,communication_delay,accuracy_ret] = weighted_fn1_sunny(delay_constraint,accuracy_constraint,num_users)
