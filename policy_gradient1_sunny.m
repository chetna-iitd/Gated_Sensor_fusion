function [tot_energy,compute_energy,communication_energy,compute_delay,communication_delay,accuracy_ret] = policy_gradient1_sunny(delay_constraint,accuracy_constraint,num_users)
...
[Observation,Reward,IsDone,LoggedSignals,tot_energy,compute_energy,communication_energy,compute_delay,communication_delay,accuracy_ret] = myStepFunction_sunny(Action,LoggedSignal);

env = rlFunctionEnv(ObservationInfo,ActionInfo,'myStepFunction_sunny','myResetFunction_sunny');
