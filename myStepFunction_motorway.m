function [NextObs,Reward,IsDone,LoggedSignals,tot_energy,compute_energy,communication_energy,compute_delay,communication_delay,accuracy_ret] = myStepFunction_motorway(Action,LoggedSignals)
load('const');
load('num_user.mat');
