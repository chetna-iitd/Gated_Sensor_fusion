function [compute_energy1, compute_energy2, communication_energy1, communication_energy2, tot_energy1, tot_energy2,compute_delay,communication_delay,accuracy_ret] = weighted_fn1_motorway(delay_constraint,accuracy_constraint,num_users)
...
accuracy=[0 0 50.5 54.2 56.7
    0 0 38.2 42.5 43.4
    0 0 42.8 53.9 53.6
    0 0 50.7 57.9 60.5
    0 0 42.3 44.5 46.1
    0 0 57.2 62.3 63.1]; %Motorway
...
for i=1:5 %layer_num
    if (i==1)%% layer 1 constraint
        w1(i,1)=(ops_layer(1,1)/((1/num_users)*11000000000));%*6000;
        w1(i,2)=(ops_layer(1,1)/((1/num_users)*11000000000));%*600;
        w2(i,1)=ac1(1,1);
        w2(i,2)=ac2(1,1);
        ...
        val_d=ops_layer(1,i)/((1/num_users)*11000000000);
        val_es=(ops_layer(1,i)/((1/num_users)*153400000000)) + (feature_layer(1,i-1)*w1_2(1,2));
        val_cs=(ops_layer(1,i)/((1/num_users)*312000000000)) + (feature_layer(1,i-1)*w1_2(1,3));
        if(i==3)
        w2(i,1)=ac1(1,2);
        w2(i,2)=ac2(1,2);
        elseif(i==5)
